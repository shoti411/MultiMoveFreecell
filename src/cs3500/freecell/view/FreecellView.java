...
/**
 * The interface for the view of the game Freecell. It contains the toString method which is needed
 * to display the Freecell game in text. It also contains the renderBoard method which prints the
 * toString display to the provided data destination, and the renderMessage method which renders the
 * specific message given to it to the provided data destination.
 */
